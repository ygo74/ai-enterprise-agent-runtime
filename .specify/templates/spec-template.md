...
- **FR-006**: System MUST define language-neutral behavior contracts for Python,
  .NET, and Java implementations, including API inputs/outputs and error semantics.
- **FR-007**: System MUST document UX consistency rules (interaction flow,
...
- **SC-005**: Cross-language parity tests pass for Python, .NET, and Java with
