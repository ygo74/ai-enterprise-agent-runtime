...
**Tests**: Test tasks are MANDATORY. Every feature MUST include unit,
integration, and parity/performance validation tasks per the constitution.
...
- [ ] T004 Inventory existing classes/functions/modules that may satisfy the feature
...
- [ ] T015 [P] [US1] Parity test validating equivalent behavior across Python/.NET/Java

### Implementation for User Story 1

- [ ] T016 [US1] Reuse or extend identified existing classes/functions; document the decision
...
- [ ] T023 [US1] Add benchmark/assertion for story-level performance budget
...
- [ ] T026 [P] [US2] Parity test validating equivalent behavior across Python/.NET/Java

### Implementation for User Story 2

- [ ] T027 [US2] Reuse or extend identified existing classes/functions; document the decision
...
- [ ] T032 [US2] Add benchmark/assertion for story-level performance budget
...
- [ ] T035 [P] [US3] Parity test validating equivalent behavior across Python/.NET/Java

### Implementation for User Story 3

- [ ] T036 [US3] Reuse or extend identified existing classes/functions; document the decision
...
- [ ] T040 [US3] Add benchmark/assertion for story-level performance budget
