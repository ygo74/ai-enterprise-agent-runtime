...
so the same manifests drive one orchestrator today and another tomorrow.
...
How a manifest is *loaded* - from YAML, from a database, from a service - is a
host decision and stays outside this library.
"""
